...
public class CredentialsMap {
	...
	Person mario = new Person("Super", "Mario", "supermario", LocalDate.parse("1988-10-11"), "supermario@nintendo.com", "ItsmeMario!1");
	Person luigi = new Person("Luigi", "Mario", "luigi", LocalDate.parse("1986-09-25"), "luigi@nintendo.com", "Number1!");
	Person pacman = new Person("Pac", "Man", "pacman", LocalDate.parse("1980-01-15"), "pacman80@gmail.com", "Paku-Paku80");
	Person isaac = new Person("Isaac", "Maffeis", "isaacmaffo96", LocalDate.parse("1996-05-10"), "isaacmaffo96@gmail.com", "Im_1041473");
