...
public class CredentialsMap {
	...
	private void addDefault() {
		...
		Person luigi = new Person("Luigi", "Mario", "luigi", LocalDate.parse("1986-09-25"), "luigi@nintendo.com", "Number1!", new Scores(2,10));
		Person pacman = new Person("Pac", "Man", "pacman", LocalDate.parse("1980-01-15"), "pacman80@gmail.com", "Paku-Paku80", new Scores(5,5));
		Person isaac = new Person("Isaac", "Maffeis", "isaacmaffo96", LocalDate.parse("1996-05-10"), "isaacmaffo96@gmail.com", "Im_1041473",new Scores(4,3));
